...
const Feedbacks = () => {
  return (
    <div className="grid sm:grid-cols-2 items-start border-2 border-t-[#EE9322] gap-16 p-4 mx-auto bg-black font-[sans-serif]">
      <div>
        <motion.div
          variants={textVariant()}
        >
          <h1 className={`${styles.sectionHeadText} font-extrabold`}>Hire Me.</h1>
          <motion.p
        ...
        <div className="mt-12">
          ...
          <ul className="mt-4">
            <li className="flex items-center">
              <div className="bg-[#03346E] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#F9E400'
        ...
        <div className="mt-12">
          ...
          <ul className="flex mt-4 space-x-4">
            <li className="bg-[#03346E] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a href="https://www.facebook.com/shiva.jagtapn/">
                <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill='yellow'
                  viewBox="0 0 24 24">
                  <path
            ...
            <li className="bg-[#03346E] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a href="https://www.linkedin.com/in/shiva-silmawala-0876261a3/">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill='yellow'
                  viewBox="0 0 511 512">
                  <path
